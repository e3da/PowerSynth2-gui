...
class Ui_CornerStitch_Dialog(object):
    def setupUi(self, CornerStitch_Dialog):
        ...
        self.btn_initial_layout = QPushButton(self.grbox_view)
        ...
        self.btn_initial_layout.setMaximumSize(QSize(125, 16777215))
        ...
        self.lineEdit_x.setMaximumSize(QSize(70, 16777215))
        ...
        self.lineEdit_y.setMaximumSize(QSize(70, 16777215))
        ...
        self.lineEdit_size_w.setMaximumSize(QSize(50, 16777215))
        ...
        self.lineEdit_size_h.setMaximumSize(QSize(50, 16777215))
