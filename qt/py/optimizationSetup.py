...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy2.setHeightForWidth(self.combo_optimization_algorithm.sizePolicy().hasHeightForWidth())
        self.combo_optimization_algorithm.setSizePolicy(sizePolicy2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_14.setText(QCoreApplication.translate("Dialog", u"Number of layouts/generation:", None))
