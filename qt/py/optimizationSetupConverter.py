...
################################################################################
## Form generated from reading UI file 'optimizationSetupConverter.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_electrical_setup.setText(QCoreApplication.translate("Dialog", u"Models Setup", None))
